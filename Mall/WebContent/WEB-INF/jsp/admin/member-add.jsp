...
<title>æ·»å ç¨æ· - H-ui.admin v3.1</title>
...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>ç¨æ·åï¼</label>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">æå¨åå¸ï¼</label>
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="city">
					<option value="" selected>è¯·éæ©åå¸</option>
					<option value="1">åäº¬</option>
					<option value="2">ä¸æµ·</option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="beizhu" cols="" rows="" class="textarea"  placeholder="è¯´ç¹ä»ä¹...æå°è¾å¥10ä¸ªå­ç¬¦" onKeyUp="$.Huitextarealength(this,100)"></textarea>
