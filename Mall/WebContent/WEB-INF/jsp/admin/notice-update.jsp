...
<div class="page-container">
	<form action="admin/updateNoticeById" method="get" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				   <textarea name="details" id="des" placeholder="请输入公告内容" required style="font-size:16px;width:600px;height:300px;"></textarea>
			</div>
		</div>
		<div class="row cl">
