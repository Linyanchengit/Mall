  ...
  <div class="Huiform">
    <form action="/" method="post">
      <table class="table table-bg">
        <tbody>
          <tr>
            <th width="100" class="text-r"><span class="c-red">*</span> ç¨æ·åï¼</th>
            <td><input type="text" style="width:200px" class="input-text" value="" placeholder="" id="user-name" name="user-name" datatype="*2-16" nullmsg="ç¨æ·åä¸è½ä¸ºç©º"></td>
          </tr>
          <tr>
            <th class="text-r"><span class="c-red">*</span> æ§å«ï¼</th>
            <td><label>
          ...
          <tr>
            <th class="text-r">ç®ä»ï¼</th>
            <td><textarea class="input-text" name="user-info" id="user-info" style="height:100px;width:300px;"></textarea></td>
          </tr>
          <tr>
            <th></th>
            <td><button class="btn btn-success radius" type="submit"><i class="icon-ok"></i> ç¡®å®</button></td>
          </tr>
        </tbody>
      </table>
    </form>
