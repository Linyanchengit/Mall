...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>å¾çæ é¢ï¼</label>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">å¾çä½èï¼</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="0" placeholder="" id="" name="">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">å¾çæ¥æºï¼</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="0" placeholder="" id="" name="">
			</div>
		</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">å¾çæè¦ï¼</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="" cols="" rows="" class="textarea"  placeholder="è¯´ç¹ä»ä¹...æå°è¾å¥10ä¸ªå­ç¬¦" datatype="*10-100" dragonfly="true" nullmsg="å¤æ³¨ä¸è½ä¸ºç©ºï¼" onKeyUp="$.Huitextarealength(this,200)"></textarea>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">å¾çä¸ä¼ ï¼</label>
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-list-container"> 
					<div class="queueList">
						<div id="dndArea" class="placeholder">
							<div id="filePicker-2"></div>
							<p>æå°ç§çæå°è¿éï¼åæ¬¡æå¤å¯é300å¼ </p>
						</div>
					</div>
					<div class="statusBar" style="display:none;">
						...
						<div class="btns">
							...
							<div class="uploadBtn">å¼å§ä¸ä¼ </div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="article_save_submit();" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> ä¿å­å¹¶æäº¤å®¡æ ¸</button>
				<button onClick="article_save();" class="btn btn-secondary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> ä¿å­èç¨¿</button>
				<button onClick="layer_close();" class="btn btn-default radius" type="button">&nbsp;&nbsp;åæ¶&nbsp;&nbsp;</button>
			</div>
		</div>
	</form>
</div>
